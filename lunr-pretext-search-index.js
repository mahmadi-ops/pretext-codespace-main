...
},
{
  ...
  "body": " Including Interactive Graphics  In this section, we will see an example of a graph created using GeoGebra.   Use the slider to observe that when , the vector becomes parallel to the tangent line.       The answer is                Compute  The sum is .                A rectangle generated by PreFigure         The derivative is \\deriv{y}{x}         A Sample PreFigure Image     a=1  f(x)=exp(x)*cos(x)       (a,f(a))                 "
},
{
